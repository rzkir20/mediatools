            ...
            <div
                ...
                <div class="order-2 lg:order-1">
                    <div class="mb-6 inline-flex items-center gap-3">
                        ...
                        <span
                            class="uppercase tracking-[0.4em] text-xs font-heading font-black text-[#22C55E]">HTML</span>
                    </div>
                    ...
                    <p class="text-white/50 text-base sm:text-lg max-w-lg mb-6 sm:mb-8">
                        Konversi file HTML statis menjadi PDF yang siap dibagikan atau
                        di-print. Cocok untuk invoice, laporan, atau halaman landing
                        sederhana.
                    </p>
                    ...
                    <div id="download-input" class="relative w-full max-w-2xl mb-8 sm:mb-10 space-y-4">
                        <div
                            ...
                            <label
                                ...
                                <input type="file" class="hidden" @change="handleFileInput" accept=".html,.htm" />
                            </label>
                        ...
                        <p class="text-xs text-white/40">
                            File HTML diproses menggunakan headless browser sehingga style CSS
                            dan background ikut ter-render. Untuk halaman yang butuh login
                            atau script dinamis kompleks mungkin hasilnya tidak selalu
                            sempurna.
                        </p>
                    </div>
                </div>
                    ...
                    <div
                        ...
                        <div class="flex flex-col items-center gap-4 px-6">
                            <div
                                ...
                                <iconify-icon icon="lucide:file-code" class="text-3xl text-[#22C55E]" />
                            </div>
                            <p class="font-heading text-lg sm:text-2xl font-black text-center leading-snug">
                                HTML to PDF
                            </p>
                            <p class="text-xs text-white/50 text-center">
                                Ubah halaman HTML statis menjadi PDF siap download dalam sekali
                                klik.
                            </p>
                        </div>
                    </div>
