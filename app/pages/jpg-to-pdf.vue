      ...
      <div
        ...
        <div class="order-2 lg:order-1">
          <div class="mb-6 inline-flex items-center gap-3">
            ...
            <span class="uppercase tracking-[0.4em] text-xs font-heading font-black text-[#22C55E]">Image</span>
          </div>
          ...
          <p class="text-white/50 text-base sm:text-lg max-w-lg mb-6 sm:mb-8">
            Ubah gambar JPG/PNG/WebP menjadi file PDF satu halaman. Cocok untuk
            scan dokumen, tanda tangan, atau bukti foto yang ingin dibagikan
            sebagai PDF.
          </p>
          ...
          <div id="download-input" class="relative w-full max-w-2xl mb-8 sm:mb-10 space-y-4">
              ...
              <label
                ...
                <div
                  ...
                  <p v-else class="text-xs sm:text-sm text-white/40 flex items-center gap-2">
                    ...
                    <span>Click to choose JPG/PNG/WebP file</span>
                  </p>
            ...
            <p class="text-xs text-white/40">
              Didukung: JPG, JPEG, PNG, WebP. Gambar akan dimasukkan ke dalam
              satu halaman PDF dengan ukuran mengikuti dimensi gambar asli
              (tanpa kompresi tambahan dari server).
            </p>
          </div>
        </div>
          ...
          <div
            ...
            <div class="flex flex-col items-center gap-4 px-6">
              <div
                ...
                <iconify-icon icon="lucide:image" class="text-3xl text-[#22C55E]" />
              </div>
              <p class="font-heading text-lg sm:text-2xl font-black text-center leading-snug">
                Image to PDF
              </p>
              <p class="text-xs text-white/50 text-center">
                Satukan scan foto atau dokumen menjadi file PDF rapi dan mudah
                dibagikan.
              </p>
            </div>
          </div>
