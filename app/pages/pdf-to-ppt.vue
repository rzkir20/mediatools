      ...
      <div
        ...
        <div class="order-2 lg:order-1">
          <div class="mb-6 inline-flex items-center gap-3">
            ...
            <span class="uppercase tracking-[0.4em] text-xs font-heading font-black text-[#22C55E]">PDF</span>
          </div>

          <h1
            class="font-heading text-4xl sm:text-5xl md:text-7xl font-black leading-[0.95] mb-6 sm:mb-8">
            PDF <br />
            <span class="text-[#22C55E]">to PowerPoint (PPTX)</span>
          </h1>

          <p class="text-white/50 text-base sm:text-lg max-w-lg mb-6 sm:mb-8">
            Konversi teks dari PDF menjadi presentasi PowerPoint (PPTX)
            sederhana. Cocok untuk PDF yang berisi poin-poin teks (bukan hasil
            scan).
          </p>
          ...
          <div id="download-input" class="relative w-full max-w-2xl mb-8 sm:mb-10 space-y-4">
            <div class="bg-[#1A1A1A] p-4 sm:p-5 rounded-2xl border border-white/5 shadow-2xl shadow-black/40">
              ...
              <label
                ...
                <input type="file" class="hidden" @change="handleFileInput" accept=".pdf" />
              </label>
              ...
              <div class="mt-4 grid grid-cols-1 sm:grid-cols-[1.3fr_auto] gap-3">
                <div>
                  ...
                  <p class="text-xs text-white/60">PPTX (PowerPoint)</p>
                </div>
            ...
            <p class="text-xs text-white/40">
              Converter ini membuat slide dengan poin teks dari PDF. Layout,
              gambar, dan tabel rumit tidak akan dipertahankan, dan PDF hasil
              scan (gambar) tidak didukung.
            </p>
          </div>
        </div>
          ...
          <div
            ...
            <div class="flex flex-col items-center gap-4 px-6">
              <div
                ...
                <iconify-icon icon="lucide:presentation" class="text-3xl text-[#22C55E]" />
              </div>
              <p class="font-heading text-lg sm:text-2xl font-black text-center leading-snug">
                PDF to PowerPoint
              </p>
              <p class="text-xs text-white/50 text-center">
                Ubah konten PDF menjadi slide sederhana yang siap dipoles di
                PowerPoint.
              </p>
            </div>
          </div>
