            ...
            <div
                ...
                <div class="order-2 lg:order-1">
                    <div class="mb-6 inline-flex items-center gap-3">
                        ...
                        <span
                            class="uppercase tracking-[0.4em] text-xs font-heading font-black text-[#22C55E]">PDF</span>
                    </div>

                    <h1 class="font-heading text-4xl sm:text-5xl md:text-7xl font-black leading-[0.95] mb-6 sm:mb-8">
                        PDF <br />
                        <span class="text-[#22C55E]">to Word (DOCX)</span>
                    </h1>

                    <p class="text-white/50 text-base sm:text-lg max-w-lg mb-6 sm:mb-8">
                        Ekstrak teks dari PDF menjadi dokumen Word (DOCX) yang bisa Anda
                        edit kembali. Cocok untuk PDF teks biasa (bukan hasil scan image).
                    </p>
                    ...
                    <div id="download-input" class="relative w-full max-w-2xl mb-8 sm:mb-10 space-y-4">
                        <div
                            ...
                            <div class="mt-4 grid grid-cols-1 sm:grid-cols-[1.3fr_auto] gap-3">
                                <div>
                                    ...
                                    <p class="text-xs text-white/60">DOCX (Word)</p>
                                </div>
                        ...
                        <p class="text-xs text-white/40">
                            Converter ini fokus ke teks; layout dan styling mungkin tidak
                            persis sama seperti PDF asli, terutama untuk dokumen yang banyak
                            gambar atau tabel kompleks.
                        </p>
                    </div>
                </div>
                    ...
                    <div
                        ...
                        <div class="flex flex-col items-center gap-4 px-6">
                            <div
                                ...
                                <iconify-icon icon="lucide:file-digit" class="text-3xl text-[#22C55E]" />
                            </div>
                            <p class="font-heading text-lg sm:text-2xl font-black text-center leading-snug">
                                PDF to DOCX
                            </p>
                            <p class="text-xs text-white/50 text-center">
                                Ubah PDF menjadi dokumen Word yang bisa diedit kembali, tanpa
                                watermark.
                            </p>
                        </div>
                    </div>
